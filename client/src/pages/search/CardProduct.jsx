    ...
    return (
        ...
        >
            <div>
                ...
                <div className="flex flex-row justify-between py-3 my-1 max-md:py-1">
                    ...
                    <h3 className="font-bold text-neutral-400 tracking-tighter">{`${product.sizes[0]}-${product.sizes[product.sizes.length-1]}`}</h3>
                </div>
                
                <div className="flex justify-between font-bold max-md:text-sm text-neutral-400 tracking-tighter text-left">
